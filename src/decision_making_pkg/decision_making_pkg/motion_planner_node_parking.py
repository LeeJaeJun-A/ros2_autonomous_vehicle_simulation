...
PARKING_START_TIME = 18.0            # ⏰ 주차 시작 시간 (초) - 직진 후 이 시간에 좌회전 시작 (4배 연장)
LEFT_TURN_DURATION = 5.0           # 좌회전 지속 시간 (초)
REVERSING_DURATION = 5.0             # ⏱️ 후진 지속 시간 (초) - 주차 깊이 조절 (줄여서 덜 깊게)
FINE_TUNING_DURATION = 3.0           # 미세 조정 시간 (초) - 후진하며 반대 방향 조향으로 각도 보정
