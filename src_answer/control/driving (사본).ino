// 최대 입력 문자 수
const unsigned int MAX_INPUT = 19;
...
// 가변저항 값 범위
const int resistance_most_left = 625;
const int resistance_most_right = 503;

// 조향 최대 단계 수 (한 쪽 기준)
const int MAX_STEERING_STEP = 9;
