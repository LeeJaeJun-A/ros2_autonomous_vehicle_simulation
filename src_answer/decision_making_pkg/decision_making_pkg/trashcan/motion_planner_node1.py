...
#--------------------------------------횡단보도 차선 변경 로직.
        ...
        if self.lane_control is False: #2차선.
            if self.path_data is None:
                ...
                self.steering_command = 9 #self.compute_steering_with_stanley2(current_v, 0.8)
        ...
        if self.lane_control: #1차선.
            if self.path_data is None:
                ...
                current_v = (self.left_speed_command + self.right_speed_command)/2.0
                self.steering_command = 9 # self.compute_steering_with_stanley1(current_v, 0.8)
