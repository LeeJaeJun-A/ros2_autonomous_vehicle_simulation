        ...
        if self.lane_control: #1차선.
            if self.path_data is None:
                ...
                if self.traffic_light == True:
                    ...
                    self.left_speed_command = 150  # 예시 속도 값 (255가 최대 속도)
                    self.right_speed_command = 150  # 예시 속도 값 (255가 최대 속도)
